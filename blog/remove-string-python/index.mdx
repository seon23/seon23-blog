...
3. 예상 결과
<p align="center">
<img src = "https://github.com/seon23/seon23-blog/blob/main/src/images/scrape-expected-result.png?raw=true" width="90%">
</p> 
...
![](../../src/images/scrape-actual-result.png)
...
![](../../src/images/scrape-html-class.png)
...
- a 태그 안에 있는 ‘19, 금, Peaches (Feat. Daniel Caesar &amp; Giveon)’ 문자가 `a.title.ellipsis.text`에 해당한다. 다른 곡들과 다르게 text가 가리키는 부분에 `19`, `금`이 포함되어 있기 때문에, text를 호출하면 이 문자가 따라올 수 밖에 없다.
